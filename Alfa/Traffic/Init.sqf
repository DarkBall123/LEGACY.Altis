...
if (_runOnThisMachine) then {
	call compile preprocessFileLineNumbers "Alfa\Traffic\Server\Functions.sqf";
	call compile preprocessFileLineNumbers "Alfa\Traffic\Server\MoveVehicle.sqf";
	call compile preprocessFileLineNumbers "Alfa\Traffic\Server\StartTraffic.sqf";
	call compile preprocessFileLineNumbers "Alfa\Traffic\ConfigAndStart.sqf";
};
